	...
	<form name="articleForm" method="post" action="${contextPath}/board/addReply.do" enctype="multipart/form-data">
		<table class="table table-bordered">
			<tr>
				...
				<td>
					<input type="text" name="title" class="form-control" value="[답글 ] : ${parentNO}번 글의 답글입니다.">
				</td>
			</tr>
			<tr>
				<th>글내용</th>
			...
			<tr>
				<td></td>
				<td colspan="2">
					<button class="btn btn-outline-primary">답글 쓰기</button>
					<button class="btn btn-outline-success" type="button" onclick="backToList(this.form)">글목록으로</button>
				</td>
			</tr>
		</table>
	</form>
